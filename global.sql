...
CREATE TABLE `m003_master_connection` (
  ...
  `write_db_port` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  ...
  `read_db_port` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
